...
class Filter(object):
    class CreditTypesTreatment(enum.IntEnum):
        ...
        Attributes:
          CREDIT_TYPES_TREATMENT_UNSPECIFIED (int): This is an invalid value.
          ...
          threshold calculations.
          INCLUDE_SPECIFIED_CREDITS (int): Credit types specified in the credit_types field are subtracted from
