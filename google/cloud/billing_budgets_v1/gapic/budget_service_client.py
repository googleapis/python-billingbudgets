...
"""Accesses the google.cloud.billing.budgets.v1 BudgetService API."""
...
from google.cloud.billing_budgets_v1.gapic import budget_service_client_config
from google.cloud.billing_budgets_v1.gapic import enums
from google.cloud.billing_budgets_v1.gapic.transports import (
    budget_service_grpc_transport,
)
from google.cloud.billing_budgets_v1.proto import budget_model_pb2
from google.cloud.billing_budgets_v1.proto import budget_service_pb2
from google.cloud.billing_budgets_v1.proto import budget_service_pb2_grpc
...
class BudgetServiceClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.billing.budgets.v1.BudgetService"
    ...
    def create_budget(
        ...
        limits <https://cloud.google.com/billing/quotas>`__ for more information
        ...
        Args:
            ...
            budget (Union[dict, ~google.cloud.billing_budgets_v1.types.Budget]): Required. Budget to create.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.billing_budgets_v1.types.Budget`
        ...
        Returns:
            A :class:`~google.cloud.billing_budgets_v1.types.Budget` instance.
    ...
    def update_budget(
        ...
        Args:
            budget (Union[dict, ~google.cloud.billing_budgets_v1.types.Budget]): Required. The updated budget object.
                The budget to update is specified by the budget name in the budget.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.billing_budgets_v1.types.Budget`
            update_mask (Union[dict, ~google.cloud.billing_budgets_v1.types.FieldMask]): Optional. Indicates which fields in the provided budget to update.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.billing_budgets_v1.types.FieldMask`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
    ...
    def list_budgets(
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.billing_budgets_v1.types.Budget` instances.
