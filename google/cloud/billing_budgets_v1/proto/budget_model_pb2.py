...
# source: google/cloud/billing_budgets_v1/proto/budget_model.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/billing_budgets_v1/proto/budget_model.proto",
...
_THRESHOLDRULE_BASIS = _descriptor.EnumDescriptor(
    name="Basis",
    full_name="google.cloud.billing.budgets.v1.ThresholdRule.Basis",
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
...
_FILTER_CREDITTYPESTREATMENT = _descriptor.EnumDescriptor(
    ...
    full_name="google.cloud.billing.budgets.v1.Filter.CreditTypesTreatment",
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="INCLUDE_SPECIFIED_CREDITS",
            index=3,
            number=3,
            serialized_options=None,
            type=None,
...
_BUDGET = _descriptor.Descriptor(
    name="Budget",
    full_name="google.cloud.billing.budgets.v1.Budget",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.billing.budgets.v1.Budget.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="display_name",
            full_name="google.cloud.billing.budgets.v1.Budget.display_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="budget_filter",
            full_name="google.cloud.billing.budgets.v1.Budget.budget_filter",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="amount",
            full_name="google.cloud.billing.budgets.v1.Budget.amount",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.Budget.threshold_rules",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.Budget.notifications_rule",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="etag",
            full_name="google.cloud.billing.budgets.v1.Budget.etag",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
_BUDGETAMOUNT = _descriptor.Descriptor(
    name="BudgetAmount",
    full_name="google.cloud.billing.budgets.v1.BudgetAmount",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.BudgetAmount.specified_amount",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.BudgetAmount.last_period_amount",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="budget_amount",
            full_name="google.cloud.billing.budgets.v1.BudgetAmount.budget_amount",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_LASTPERIODAMOUNT = _descriptor.Descriptor(
    ...
    full_name="google.cloud.billing.budgets.v1.LastPeriodAmount",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
...
_THRESHOLDRULE = _descriptor.Descriptor(
    name="ThresholdRule",
    full_name="google.cloud.billing.budgets.v1.ThresholdRule",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.ThresholdRule.threshold_percent",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="spend_basis",
            full_name="google.cloud.billing.budgets.v1.ThresholdRule.spend_basis",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
_NOTIFICATIONSRULE = _descriptor.Descriptor(
    name="NotificationsRule",
    full_name="google.cloud.billing.budgets.v1.NotificationsRule",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="pubsub_topic",
            full_name="google.cloud.billing.budgets.v1.NotificationsRule.pubsub_topic",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="schema_version",
            full_name="google.cloud.billing.budgets.v1.NotificationsRule.schema_version",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.NotificationsRule.monitoring_notification_channels",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="disable_default_iam_recipients",
            full_name="google.cloud.billing.budgets.v1.NotificationsRule.disable_default_iam_recipients",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
_FILTER_LABELSENTRY = _descriptor.Descriptor(
    name="LabelsEntry",
    full_name="google.cloud.billing.budgets.v1.Filter.LabelsEntry",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="google.cloud.billing.budgets.v1.Filter.LabelsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="google.cloud.billing.budgets.v1.Filter.LabelsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FILTER = _descriptor.Descriptor(
    name="Filter",
    full_name="google.cloud.billing.budgets.v1.Filter",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="projects",
            full_name="google.cloud.billing.budgets.v1.Filter.projects",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="credit_types",
            full_name="google.cloud.billing.budgets.v1.Filter.credit_types",
            index=1,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.billing.budgets.v1.Filter.credit_types_treatment",
            index=2,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="services",
            full_name="google.cloud.billing.budgets.v1.Filter.services",
            index=3,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="subaccounts",
            full_name="google.cloud.billing.budgets.v1.Filter.subaccounts",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="google.cloud.billing.budgets.v1.Filter.labels",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
_BUDGET.fields_by_name["notifications_rule"].message_type = _NOTIFICATIONSRULE
...
_FILTER_LABELSENTRY.fields_by_name[
    "value"
...
DESCRIPTOR.message_types_by_name["NotificationsRule"] = _NOTIFICATIONSRULE
...
Budget = _reflection.GeneratedProtocolMessageType(
    ...
    {
        "DESCRIPTOR": _BUDGET,
        "__module__": "google.cloud.billing_budgets_v1.proto.budget_model_pb2",
  ...
  Attributes:
      ...
      display_name:
          User data for display name in UI. The name must be less than
      ...
      notifications_rule:
          Optional. Rules to apply to notifications sent based on budget
...
NotificationsRule = _reflection.GeneratedProtocolMessageType(
    "NotificationsRule",
    (_message.Message,),
    {
        "DESCRIPTOR": _NOTIFICATIONSRULE,
        "__module__": "google.cloud.billing_budgets_v1.proto.budget_model_pb2",
        "__doc__": """NotificationsRule defines notifications that are sent based on budget
  spend and thresholds.
  ...
  Attributes:
      pubsub_topic:
          ...
          programmatic-notifications for more details on Pub/Sub roles
          and permissions.
      schema_version:
      ...
      monitoring_notification_channels:
          ...
          billing account IAM roles. The value is the full REST resource
      ...
      disable_default_iam_recipients:
          Optional. When set to true, disables default notifications
...
Filter = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      credit_types:
          Optional. If [Filter.credit_types_treatment][google.cloud.bill
          ing.budgets.v1.Filter.credit_types_treatment] is
          INCLUDE_SPECIFIED_CREDITS, this is a list of credit types to
          be subtracted from gross cost to determine the spend for
          threshold calculations.  If [Filter.credit_types_treatment][go
          ogle.cloud.billing.budgets.v1.Filter.credit_types_treatment]
          is **not** INCLUDE_SPECIFIED_CREDITS, this field must be
          empty. See `a list of acceptable credit type values
          <https://cloud.google.com/billing/docs/how-to/export-data-
          bigquery-tables#credits-type>`__.
      credit_types_treatment:
      ...
      subaccounts:
          ...
          only this set of subaccounts should be included in the budget.
          If a subaccount is set to the name of the parent account,
          usage from the parent account will be included. If the field
          is omitted, the report will include usage from the parent
          account and all subaccounts, if they exist.
      labels:
          Optional. A single label and value pair specifying that usage
          from only this set of labeled resources should be included in
          the budget. Currently, multiple entries or multiple values per
          entry are not allowed. If omitted, the report will include all
