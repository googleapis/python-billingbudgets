...
Filter = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      subaccounts:
          ...
          If a subaccount is set to the name of the master account,
          usage from the master account will be included. If omitted,
          the report will include usage from the master account and all
      ...
      labels:
          ...
          the budget. Multiple entries or multiple values per entry are
          not allowed. If omitted, the report will include all labeled
          and unlabeled usage.
  """,
