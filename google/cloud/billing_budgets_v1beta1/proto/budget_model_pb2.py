...
AllUpdatesRule = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      disable_default_iam_recipients:
          ...
          sent when a threshold is exceeded. Recipients are those with
          Billing Account Administrators and Billing Account Users IAM
